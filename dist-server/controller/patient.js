...
var patientsRecords = exports.patientsRecords = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _db["default"].query('SELECT * FROM patients WHERE lastname ILIKE :lastname', {
            replacements: {
              lastname: "%nza"
            },
            mapToModel: true,
            model: _patient["default"],
            type: _sequelize.QueryTypes.SELECT
          });
        case 2:
          patients = _context.sent;
          (0, _response.sendJsonResponse)(res, 200, patients);
          // Patient.findAll(
          //     {
          //         attributes:{
  ...
  return function patientsRecords(_x, _x2) {
